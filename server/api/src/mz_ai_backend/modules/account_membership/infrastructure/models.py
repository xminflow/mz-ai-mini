...
class AccountMembershipOrderModel(Base):
    """SQLAlchemy model for website account membership orders."""

    __tablename__ = "account_membership_orders"
    ...
    last_wechat_query_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=False), nullable=True)
