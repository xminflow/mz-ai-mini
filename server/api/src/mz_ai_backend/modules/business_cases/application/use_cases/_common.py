...
def build_registration(
    ...
    *,
    ...
    return BusinessCaseRegistration(
        ...
        data_cutoff_date=command.data_cutoff_date,
        freshness_months=command.freshness_months,
...
def build_detail_result(case: BusinessCase) -> BusinessCaseDetailResult:
    ...
    return BusinessCaseDetailResult(
        ...
        data_cutoff_date=case.data_cutoff_date,
        freshness_months=case.freshness_months,
