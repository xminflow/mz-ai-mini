...
export const STAGE1_CHAPTERS: Chapter[] = [
  {
    ...
    warning: {
      label: "零基础提示",
      body: "1.1 与 1.2 是整门课的地基，宁可慢一点。学员在这里建立的概念地图，决定了后面九节课是否「踩得稳」。",
    },
    lessons: [
      {
        code: "1.1",
        title: "开发世界速览",
        brief: "用大白话讲清前端、后端、数据库、终端，给后面所有内容打地基。",
      },
      {
        code: "1.2",
        title: "认识并安装主力工具",
        brief: "一个主力工具贯穿全程 + 其余工具横向了解，降低学习负担。",
      },
      {
        code: "1.3",
        title: "搭建自己的 AI 开发环境",
        brief: "编辑器 + 终端 + AI 工具三件套如何协同工作。",
      },
      {
        code: "1.4",
        title: "设计自己的 AI 编程工作流",
        brief: "提需求 → 看产出 → 读报错 → 再交流的核心闭环。",
      },
      {
        code: "1.5",
        title: "用 AI 做出第一版能本地打开的网页",
        brief: "完成第一次完整的「描述—生成—调整」闭环。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "2.1",
        title: "学会与 AI 高效交流(核心)",
        brief: "清晰描述需求、有效贴报错、拆分复杂任务、给错答案时如何纠偏。",
      },
      {
        code: "2.2",
        title: "各类智能体工具的使用技巧",
        brief: "横向对比国内外工具的定位与取舍，知道何时用什么。",
      },
      {
        code: "2.3",
        title: "让 AI 帮你复用经验",
        brief: "把常用提示词沉淀为模板库，用规则文件让 AI 记住项目规范。",
      },
      {
        code: "2.4",
        title: "用 AI 搭建个人知识库并持续赋能",
        brief: "让知识库成为可随时查询的「外脑」，积累随时间复利。",
      },
    ],
  },
  {
    ...
    theme: "frontend",
    intro: "承接第一节课的静态页面，把它升级为有设计感、能适配手机的版本。",
    lessons: [
      {
        code: "3.1",
        title: "如何让你的应用更加美观",
        brief: "掌握配色、排版、间距、对齐等基础原则，并准确传达给 AI。",
      },
      {
        code: "3.2",
        title: "如何制作炫酷的动画效果",
        brief: "过渡、悬停、加载等常见动画，让页面活起来。",
      },
      {
        code: "3.3",
        title: "如何使用市面上现成的组件库",
        brief: "理解组件能省下多少工作，让 AI 帮你接入与使用。",
      },
      {
        code: "3.4",
        title: "把第一版页面升级为美观的前端站点",
        brief: "综合运用配色、动画、组件完成一次完整的美化迭代。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "4.1",
        title: "设计整个应用的主题效果",
        brief: "用变量统一管理颜色、字体、圆角，一处修改全局生效。",
      },
      {
        code: "4.2",
        title: "如何设计可复用的组件",
        brief: "识别页面中重复出现的结构，让 AI 帮你抽象成组件。",
      },
      {
        code: "4.3",
        title: "如何将自己的工程整理得井井有条",
        brief: "合理的目录结构与命名规范，是长期维护的前提。",
      },
      {
        code: "4.4",
        title: "如何通过 AI 查找和修复前端问题",
        brief: "看懂控制台报错并喂给 AI，闭环「报错—定位—修复—验证」。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "5.1",
        title: "后端是什么 + 用 AI 搭建管理数据库",
        brief: "先花足篇幅讲明白「数据存哪、接口是什么」，再动手建库。",
      },
      {
        code: "5.2",
        title: "基于 AI 搭建自己的后端开发环境",
        brief: "把后端跑起来，让 AI 一步步配置并启动环境。",
      },
      {
        code: "5.3",
        title: "开发自己的第一个后端接口",
        brief: "实现「新增 / 读取一条数据」接口并存进数据库，用工具测试通。",
      },
      {
        code: "5.4",
        title: "连接前后端 + 联调排错专题(难点)",
        brief: "跨域、接口格式、异步问题——历史劝退重灾区，系统化排错。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "6.1",
        title: "借助 AI 管理后端服务工程结构",
        brief: "后端代码的合理分层与组织，用 AI 协助梳理。",
      },
      {
        code: "6.2",
        title: "设计后端服务的日志系统",
        brief: "为后面「分析问题」做铺垫，给服务加上清晰日志。",
      },
      {
        code: "6.3",
        title: "如何基于 AI 分析后端问题并修复",
        brief: "形成「看日志—定位—交给 AI」的闭环并验证修复。",
      },
      {
        code: "6.4",
        title: "业务拆解 + 数据安全基础",
        brief: "在拆解业务的同时把敏感数据与密钥保护意识打牢。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "7.1",
        title: "认识智能体的基本结构",
        brief: "破除神秘感:它本质是个会调用大模型 API 的后端服务。",
      },
      {
        code: "7.2",
        title: "使用 AI 来设计自己的智能体",
        brief: "定义角色与能力边界，用 AI 协助设计提示词与行为。",
      },
      {
        code: "7.3",
        title: "给智能体接入记忆系统",
        brief: "衔接第五节课数据库:记忆本质就是把对话存下来。",
      },
      {
        code: "7.4",
        title: "开发出自己的第一个 AI 智能体应用",
        brief: "完整跑通一次真实对话，让记忆系统真正生效。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "8.1",
        title: "学会使用腾讯云服务器",
        brief: "云服务器是什么、如何购买与连接，掌握基本操作。",
      },
      {
        code: "8.2",
        title: "如何使用 AI 管理服务器",
        brief: "让 AI 当你的运维助手，安全完成常见服务器操作。",
      },
      {
        code: "8.3",
        title: "如何构建自己的生产环境",
        brief: "讲清「本地能跑 ≠ 线上能跑」这一新手大坑。",
      },
      {
        code: "8.4",
        title: "如何使用自己的域名",
        brief: "域名是什么、如何购买与解析，指向你的服务器。",
      },
      {
        code: "8.5",
        title: "如何自动申请 HTTPS 证书",
        brief: "让访问更安全、更专业，自动申请并续期。",
      },
      {
        code: "8.6",
        title: "将应用发布到公网并验证",
        brief: "用手机实地验证线上访问，并完成上线检查清单。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "9.1",
        title: "准备小程序开发环境",
        brief: "小程序账号与开发者工具，理解与网页开发的异同。",
      },
      {
        code: "9.2",
        title: "如何在小程序中设计自己的应用主题",
        brief: "把第四节课的主题思路迁移到小程序，掌握界面要点。",
      },
      {
        code: "9.3",
        title: "基于 AI 开发自己的小程序应用",
        brief: "用熟悉的 AI 工作流，把已有应用的核心功能搬进小程序。",
      },
      {
        code: "9.4",
        title: "复用已有后端构造小程序服务",
        brief: "直接对接第五、六节课的后端，不重复造轮子。",
      },
      {
        code: "9.5",
        title: "学会如何上线自己的小程序",
        brief: "掌握提交、审核、发布与后续更新流程。",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        code: "10.1",
        title: "保证系统整洁 + 数据备份策略",
        brief: "承接第六节课的安全意识，落到具体的备份与恢复实践。",
      },
      {
        code: "10.2",
        title: "如何升级迭代自己的应用",
        brief: "建立版本管理思想，安全发布与出问题如何回退。",
      },
      {
        code: "10.3",
        title: "如何与其他人协作",
        brief: "从单打独斗到团队协作，用 AI 辅助沟通与代码整合。",
      },
      {
        code: "10.4",
        title: "如何监控自己的应用访问数据",
        brief: "关注关键访问指标，用监控发现潜在问题。",
      },
      {
        code: "10.5",
        title: "好产品的设计维度 + 课程总复盘",
        brief: "设计一个好产品要考虑的核心维度，复盘从想法到上线的全旅程。",
      },
    ],
  },
];
...
export const STAGE1_SERVICE_STAGES: ServiceStage[] = [
  {
    ...
    duration: "1 个月",
    title: "线上直播 · 集中授课",
    highlight: "每周固定时间在线直播 · 跟着节奏走完课程主线",
    body: "把系统化课程结构化交付给你，现场答疑、现场演示，节奏紧凑而不慌乱——一个月跑通从认识工具到独立上线全流程。",
    features: [
      "每周固定时间在线直播，逐节推进",
      "现场答疑、现场演示，不容易掉队",
      "直播全程录像，永久回放、可反复看",
...
export const PROJECT_TIMELINE: TimelineNode[] = [
  {
    chapter: "课时 1",
    milestone: "静态网页",
    detail: "用 AI 做出第一版能在本地浏览器打开的网页。",
    theme: "cognition",
  },
  {
    chapter: "课时 3",
    milestone: "美观响应式",
    detail: "掌握设计原则与组件库，做出美观、适配手机的页面。",
    theme: "frontend",
  },
  {
    chapter: "课时 4",
    milestone: "前端工程化",
    detail: "主题、组件、目录结构与控制台排错四件套到位。",
    theme: "frontend",
  },
  {
    chapter: "课时 5",
    milestone: "接上后端",
    detail: "数据库 + 接口 + 联调，第一个真正能用的全栈应用。",
    theme: "backend",
  },
  {
    chapter: "课时 6",
    milestone: "后端工程化",
    detail: "给后端加上日志、分层与数据安全基础。",
    theme: "backend",
  },
  {
    chapter: "课时 7",
    milestone: "智能体应用",
    detail: "做出一个可对话、有记忆的 AI 智能体应用。",
    theme: "agent",
  },
  {
    chapter: "课时 8",
    milestone: "部署上线",
    detail: "服务器、域名、HTTPS——让应用真正能被公网访问。",
    theme: "launch",
  },
  {
    chapter: "课时 9",
    milestone: "小程序形态",
    detail: "复用已有后端，发布一个微信小程序版本。",
    theme: "mobile",
  },
  {
    chapter: "课时 10",
    milestone: "长期维护",
    detail: "形成版本管理、备份、监控与产品设计的工程心智。",
    theme: "mindset",
  },
];
...
export const OVERVIEW_CARDS = [
  ...
  },
  {
    eyebrow: "02",
    title: "能力主线",
    body: "每一节课时都不是孤立练习——前端、后端、智能体、上线、小程序按序叠加，后一节课时的能力都建立在前一节之上。每节课时都有看得见、摸得着的交付物。",
    theme: "backend" as ThemeKey,
  },
  {
    eyebrow: "03",
    title: "核心理念",
    body: "AI 不是魔法。学会「如何描述需求、如何读懂报错、如何把问题讲清楚给 AI」，是比任何具体工具都重要的能力——这条暗线将贯穿全部课时反复训练。",
...
export const STAGE2_GROUPS: Stage2Group[] = [
    ...
    lessons: [
      {
        ...
        output:
          "一套可复用的个人 AI 开发工作流配置(CLAUDE.md / 自定义命令 / hooks)",
        outputDraft: true,
        theme: "advance",
      },
      {
  ...
  },
  {
    key: "enterprise",
    title: "企业实战直播",
    subtitle: "从零搭三套可上线的企业级系统(课 9–14)",
    lessons: [
      {
        code: "S2-9",
        title: "企业级实战直播 · 大数据 AI 智能分析系统（上）",
        hours: "待确认",
        goal: "从零搭起系统的数据底座与智能问数核心链路。",
        points: [
        ...
        output: '跑通"提问 → 生成查询 → 返回结果"的智能问数最小闭环。',
        theme: "enterprise",
      },
      {
        code: "S2-10",
        title: "企业级实战直播 · 大数据 AI 智能分析系统（下）",
        hours: "待确认",
        goal: "从问数升级到自动洞察，并打磨成可上线、准确、安全的产品。",
        points: [
        ...
        output: "把大数据 AI 智能分析系统部署到可访问环境，并加上权限控制。",
        theme: "enterprise",
      },
      {
        code: "S2-11",
      ...
      {
        code: "S2-13",
        title: "企业级实战直播 · AI 工作流与智能体 SaaS 平台（上）",
        hours: "待确认",
        goal: "搭起多租户 SaaS 骨架与可视化工作流引擎。",
        points: [
        ...
        output: '跑通"拖拽编排 → 一键运行 → 返回结果"最小闭环。',
        theme: "enterprise",
      },
      {
        code: "S2-14",
        title: "企业级实战直播 · AI 工作流与智能体 SaaS 平台（下）",
        hours: "待确认",
        goal: "把平台做成能对外卖、能运营的 SaaS 产品。",
        points: [
        ...
        output: "把 SaaS 平台部署上线，带租户、计费与监控。",
        theme: "enterprise",
      },
    ],
  },
  {
    key: "career",
    title: "求职冲刺",
    subtitle: "把课程实战讲成 offer(课 15–16)",
    lessons: [
      {
        code: "S2-15",
...
export const STAGE2_DELIVERABLES: Stage2Deliverable[] = [
  {
    code: "01",
    title: "一套企业级 AI 工程能力",
    subtitle: "测试 · 运维 · SDD · 整洁架构",
    body: "从有效测试、可观测运维、规范驱动开发到整洁架构与 DDD,补齐职业开发者真正缺的工程地图,并教 AI 守住架构。",
    badges: ["分层测试", "CI/CD", "架构约束"],
    theme: "advance",
  },
  {
    code: "02",
    title: "RAG 问答应用 + 带记忆的智能体",
    subtitle: "大模型应用核心能力 · 可运行",
    body: "把私有文档接进模型做出最小 RAG 问答应用,并从零实现一个带工具调用与基础记忆的可控智能体。",
    badges: ["RAG", "工具调用", "记忆系统"],
    theme: "advance",
  },
  {
    code: "03",
    title: "大数据 AI 智能分析系统(可上线)",
    subtitle: "智能问数 · AI 出图表洞察 · 带权限与数据安全",
    body: "从「提问 → 生成查询 → 返回结果」最小闭环,到大数据存储计算管线、AI 自动出图表与异常/趋势洞察、行级权限与防注入,部署到可访问环境。",
    badges: ["大数据分析", "AI 洞察", "可上线"],
    theme: "enterprise",
  },
  {
    code: "04",
    title: "Hermes/Openclaw 智能体系统(可上线)",
    subtitle: "引擎 · 工具 · 记忆 · 监控",
    body: "从智能体主循环、工具系统到长期记忆、多轮编排、异常降级与生产监控,搭出一套能上线、稳定、可运营的智能体系统。",
    badges: ["Agent 引擎", "生产部署", "监控告警"],
    theme: "enterprise",
  },
  {
    code: "05",
    title: "AI 工作流与智能体 SaaS 平台(可上线)",
    subtitle: "可视化编排 · 多租户 · 计费与监控",
    body: "从可视化工作流画布、DAG 执行引擎、多智能体协作与工具调用,到版本管理、租户权限计费与运行监控,做出一套能对外运营的 SaaS 平台。",
    badges: ["工作流编排", "多租户 SaaS", "计费监控"],
    theme: "enterprise",
  },
  {
    code: "06",
    title: "面试题库 + 个人答案稿",
    subtitle: "大模型应用 / VibeCoding 与架构 两方向",
    body: "把课程里的 RAG / 智能体 / 架构实战,用 STAR 结构讲到面试官认可;沉淀两方向的高频题库与个人答案稿。",
    badges: ["题库", "STAR 讲述", "答案稿"],
    theme: "career",
  },
];
...
export const STAGE2_SERVICE_DRAFT = {
  ...
  body: "第二阶段以企业级实战直播为主,持续 3 个月,带你从零做出大数据 AI 智能分析、智能体系统与 AI 工作流 SaaS 平台三套可上线系统;在 6 个月服务期内,直播之外的真实项目、求职准备等问题持续陪跑答疑。",
  features: [
...
export const STAGE2_PRICE = { now: "¥3999", original: "¥5999" };
